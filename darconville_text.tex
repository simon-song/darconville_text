...
\setlength\cftchapternumwidth{7.5em}
%\setlength\cftsectionindent{3em}
\renewcommand{\cftchapterpresnum}{\hfill}% Inserted before \chapter numbers in ToC
\renewcommand{\cftchapteraftersnum}{\quad}% Inserts after \chapter numbers in ToC
